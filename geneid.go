...
// The geneiIds are the "innovation numbers" used in NEAT CPPNs. If two genes have the same gene id, they are the same gene
...
// it may set the max gene id to ensure that new evolutions don't get confused with CPPN genes that already exist.
